...
def ingresar_problema():
    """
    Defines the cost, supply, and demand matrix for the transportation problem.
    If the problem is unbalanced, automatically adds a dummy row/column.
    Returns: (costs, supply, demand)
    """
    costos = np.array([
        [5, 2, 7, 3],
        [3, 6, 6, 1],
